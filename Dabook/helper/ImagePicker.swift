...
extension ImagePicker: UIImagePickerControllerDelegate {
    ...
    public func imagePickerController(_ picker: UIImagePickerController,
        ...
        guard let image = info[.editedImage] as? UIImage else {
            guard (info[UIImagePickerController.InfoKey.mediaURL] as? NSURL) != nil else {
                return self.pickerController(picker, didSelect: nil, url: nil)
            }
            return self.pickerController(picker, didSelect: nil, url: info[UIImagePickerController.InfoKey.mediaURL] as? NSURL)
        }
        self.pickerController(picker, didSelect: image, url: info[UIImagePickerController.InfoKey.mediaURL] as? NSURL)
    }
}
